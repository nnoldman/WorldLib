...
namespace World
{
    public static class Config
    {
        ...
        public static string TokenTrue = "是";
        public static string TokenFalse = "不";
        public static string TokenSpace = " ";
        public static string TokenName = "名称";
        public static string TokenMe = "你";
        public static string TokenYou = "我";
        public static string TokenOwnership = "所属";
        public static string TokenInnate = "与生俱来";
        public static string TokenMood = "头脑";
        public static string TokenBody = "身体";
        public static string TokenBe1 = "是";
        public static string TokenBe2 = "是";
        public static string TokenBe3 = "是";
        public static string TokenDefineMyself = "类人";
        public static string TokenDefine = "定义";
